...
export const demoMessages: Record<string, ChatMessage[]> = {
  U00000000000000000000000000000001: [
    { id: "demo-1", direction: "inbound", status: "sent", text: "สวัสดีครับ", sentAt: new Date(now - 8 * 60_000).toISOString() },
    { id: "demo-2", direction: "inbound", status: "sent", text: "ขอสอบถามข้อมูลครับ", sentAt: new Date(now - 7 * 60_000).toISOString() },
    { id: "demo-3", direction: "outbound", status: "sent", text: "สวัสดีค่ะ ยินดีให้บริการ", sentAt: new Date(now - 5 * 60_000).toISOString() },
  ],
};
